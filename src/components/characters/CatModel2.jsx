...
const CatModel2 = forwardRef((props, ref) => {
    const { catModel } = useCatModel();
    const catModelRef = useRef();
    const { nodes, materials, animations } = useGLTF('./assets/character/threedy-realease2.glb');
...
useGLTF.preload('./assets/character/threedy-realease2.glb');

export default CatModel2;
